...
4.  **심층 분석:** 부정 리뷰에 대한 카테고리별 불만 언급 빈도 분석
...
2.  **도구 활용:** Gemi석에서는 클러스터링 파라미터를 더욱 세밀하게 조정하거나, 사전 학습된 임베딩 모델을 한국어 텍스트에 더욱 최적화하는 방안을 모색하여, 이번에 아쉬움으로 남았던 주제 분석 결과를 도출할 것이다.
